          ...
          <div className="flex flex-col md:flex-row gap-4 md:items-center">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border rounded-lg w-full md:w-64 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-gray-900"
              />
            </div>
            ...
            <select
              ...
              className="p-2 border rounded-lg bg-white shadow-sm focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-gray-900"
            >
